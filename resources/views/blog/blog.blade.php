...
<div class="container py-6 pb-10 px-sm">
    ...
    <ul class="list-group mt-4">
        <li class="list-group-item">
            <input class="form-check-input me-1" type="checkbox" name="categoria[]" value="Consejos de salud"
                {{ in_array('Consejos de salud', request('categoria', [])) ? 'checked' : '' }}>
            <label>Consejos de Salud</label>
        </li>

        <li class="list-group-item">
            <input class="form-check-input me-1" type="checkbox" name="categoria[]" value="Noticias"
                {{ in_array('Noticias', request('categoria', [])) ? 'checked' : '' }}>
